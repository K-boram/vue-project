...
const columns = ref([
  ...
  { label: 'Subtitle', field: 'subtitle', width: 'expand' },
...
const tableData = ref([
  {
    category: 'STAY, HOME WELLNESS, SEASONAL',
    image: 'https://d14bb7e1iugt0z.cloudfront.net/en/accommodation/download/1058/King%20Suite%20with%20Onsen%28611%29_03.jpg',
    title: 'Resident Retreat',
    subtitle: '25% off our standard room rates, summer gondola rides, on-property credits and other exclusive perks',
    date: '2024.10.22',
    status: 'Public',
  },
  {
